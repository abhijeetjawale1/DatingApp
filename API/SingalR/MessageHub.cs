...
namespace API.SingalR
{
    public class MessageHub : Hub
    {
        ...
        private async Task<Group>AddToGroup(string groupName)//remove hubcaller conetxt later
        {
            var group=await _unitOfWork.MessageRepository.GetMessageGroup(groupName);
        ...
        private async Task<Group> RemoveFromMessageGroup()//remove conn id later
        {
